<script setup>
	...
	const { saveView, activeSaveView, saveViewList } = composable.usePerson();
			...
			<div
				...
				<div class="flex xl:w-fit w-full items-center sm:gap-8 gap-4">
					<h2
						...
						{{ store.recordsDataLength }} People
					</h2>
					<h2
						v-else-if="store.recordsDataLength <= 1"
						class="text-2xl max-sm:hidden sm:inline font-bold">
						{{ store.recordsDataLength }} Person
					</h2>
